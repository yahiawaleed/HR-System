...
if ($attendanceReport -and $attendanceReport.summary) {
...
if ($clockOut) {
    Write-Host "    Clock-out result received" -ForegroundColor Gray
}

# 12. CREATE AND DELETE TEST
Write-Host "`n========== CREATE/DELETE TEST ==========" -ForegroundColor Cyan
$testHolidayBody = '{"name":"Test Holiday API","startDate":"2025-12-25","endDate":"2025-12-25","type":"NATIONAL","description":"Test API","active":true}'
